# Generated by Django 4.2.4 on 2023-11-13 17:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='app.flight')),
                ('passengers', models.ManyToManyField(related_name='flight_tickets', to='app.passengers')),
